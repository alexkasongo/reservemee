<template>
    ...
    >
            ...
            <v-toolbar flat>
                ...
                <div v-model="dialog" max-width="500px">
                    <div>
                        ...
                        <div>
                            <div color="teal darken-1" text @click="close">
                                Cancel
                            </div>
                            <div color="teal darken-1" text @click="save">
                                Save
                            </div>
                        </div>
                    </div>
        ...
        <template v-slot:[`item.services`]="">
            <div elevation="0" small class="mr-2">View Services</div>
        </template>
        <template v-slot:no-data>
            <div color="primary" @click="initialize">Reset</div>
        </template>
    </v-data-table>
</template>
